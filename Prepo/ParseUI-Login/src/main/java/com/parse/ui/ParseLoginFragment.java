...
//      usernameField.setCompletionHint("Email");
            ...
            new GraphRequest.GraphJSONObjectCallback() {
              ...
              public void onCompleted(JSONObject fbUser,
                ...
                if (fbUser != null && parseUser != null
                  ...
                  parseUser.put(USER_OBJECT_NAME_FIELD, fbUser.optString("email"));
                  parseUser.put("name", fbUser.optString("name"));
                  parseUser.put("email", fbUser.optString("email"));
                  parseUser.put("Picture", fbUser.optString("picture"));
                  //parseUser.put("birthday", fbUser.optString("birthday"));
                  parseUser.put("emailVerfied", true);
