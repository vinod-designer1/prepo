...
public abstract class AbstractWheelView extends AbstractWheel {
    ...
    protected static final int DEF_ITEM_OFFSET_PERCENT = 20;

    protected static final int DEF_ITEM_PADDING = 20;
    
    protected static final int DEF_SELECTION_DIVIDER_SIZE = 10;
